...
let HomeFeatures = () => {
  ...
  return (
    <Container className="py-5">
      <Row>
        <Feature
          title="Nước ngọt đóng chai"
          description="Đủ các loại lựa chọn thoải mái"
          img={data.slide1.childImageSharp.fluid}
        />
        <Feature
          title="Nước giải khát"
          description="Luôn mát lạnh xua tan cơn nóng mùa hè"
          img={data.slide2.childImageSharp.fluid}
        />
        <Feature
          title="Đồ uống bảo quản"
          description="Giữ nguyên hương vị của mọi sản phẩm"
