...
import { FaInstagram, FaFacebookF, FaMapMarkerAlt, FaPhone, FaMailchimp } from 'react-icons/fa';
      ...
      <Container>
        <div className="d-flex py-2 align-items-center">
          ...
          <div className="d-flex">
            ...
            />
            <HeaderItem
              text={"Email: admin@smartphonecambodia.com"}
              type="address"
              Icon={FaMailchimp}
              url={"mailto:admin@smartphonecambodia.com"}
              klass="d-sm-flex d-none mr-3"
            />
            {facebook_url ? (
              <IconLink
